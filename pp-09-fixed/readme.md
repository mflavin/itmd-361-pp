...
2. Write the name of your group members here: Michael Farrell

3. Copy and paste the URL for your group’s organization here: https://github.com/Free-Wifi

4. Copy and paste the URL for your shared repository here: https://github.com/Free-Wifi/Project-3.git
...
Write the URL for your personal fork of the repository here: https://github.com/mflavin/Project-3.git
...
Write the output of `git remote -v` from your copy of the forked repository here: group  https://github.com/Free-Wifi/Project-3.git (fetch)

                                                                                  group  https://github.com/Free-Wifi/Project-3.git (push)
                                                                                  
                                                                                  origin https://github.com/mflavin/Project-3.git   (fetch)
                                                                                  
                                                                                  origin https://github.com/mflavin/Project-3.git   (push)
...
Write the URL of your pull request here: https://github.com/Free-Wifi/Project-3/pull/1
